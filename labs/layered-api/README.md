...
The v1 contract has one `books` resource and three use cases: list, get by ID, and create. It is
complete when the API runs without external infrastructure, its focused checks pass, and a create
flow can be traced from HTTP to service to repository and back.
